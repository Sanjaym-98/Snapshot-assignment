...
const MountainPage=()=>{
    ...
    useEffect(()=>{
        const url = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=b8c77ace86b4ac039f289bfe356300db&tags=mountains&format=json&nojsoncallback=1';
